...
- **2026.03**: 프로젝트 초기 설계 및 기본 타일·이동 시스템 구현
- **2026.04**: 챕터 1~4 스테이지 제작, Command Pattern 기반 Undo 시스템 완성, 듀얼 맵·색상 토글·Steam 연동 구현
- **2026.05**: 게임 클리어 UI 구현 및 BGM/효과음 구현 진행, 2026 PlayX4 전시 대응
- **2026.06**: Steam 업적·미션 시스템·클리어 연출
